...
@Tag(name = "Datos Comerciales", description = "Operaciones para gestionar los datos comerciales de un tercero (límite de crédito, plazo de pago y nivel de riesgo).")
public class CommercialDataController { 
     ...
     */
    @Operation(
        summary = "Crear datos comerciales de un tercero",
        description = "Crea un nuevo registro de datos comerciales para un tercero. " +
     ...
     */
    @Operation(
        summary = "Actualizar datos comerciales de un tercero",
        description = "Actualiza el registro de datos comerciales vigente de un tercero. " +
     ...
     */
    @Operation(
        summary = "Consultar datos comerciales de un tercero",
        description = "Retorna el registro de datos comerciales vigente de un tercero."
    )
    @ApiResponses({
     ...
     */
    @Operation(
        summary = "Eliminar datos comerciales de un tercero",
        description = "Realiza un soft delete del registro de datos comerciales vigente de un tercero."
    )
    @ApiResponses({
