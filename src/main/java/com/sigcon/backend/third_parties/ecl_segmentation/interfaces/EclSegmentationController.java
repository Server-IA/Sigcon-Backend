...
public class EclSegmentationController { 
     ...
     */
    @Operation(summary = "Consultar segmento vigente de un cliente", 
               description = "RF08 — Retorna el segmento de riesgo ECL vigente de un cliente, incluyendo si fue calculado automáticamente o ajustado manualmente. "
    )
    @ApiResponses({
     ...
     */
    @Operation(summary = "Exportar lista paginada de clientes segmentados para cierre NIIF/GL. ", 
               description = "RF08 HU Caso 4 — Retorna la lista paginada de todos los clientes con su segmento de riesgo ECL vigente. " +
     ...
     */
    @Operation(
        summary = "Consultar histórico de cambios de segmento de un cliente",
        description = "RF08 — Retorna el histórico completo de cambios de segmento de riesgo ECL de un cliente, ordenado de más reciente a más antiguo."
    )
    @ApiResponses({
