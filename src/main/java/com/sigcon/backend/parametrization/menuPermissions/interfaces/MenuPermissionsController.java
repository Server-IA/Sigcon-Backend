...
public class MenuPermissionsController {
    ...
    @PostMapping
    @PreAuthorize("hasAuthority('PERM_VIEW_MENU_PERMISSIONS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PostMapping("/store")
    @PreAuthorize("hasAuthority('PERM_CREATE_MENU_PERMISSIONS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PutMapping("/update")
    @PreAuthorize("hasAuthority('PERM_UPDATE_MENU_PERMISSIONS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PreAuthorize("hasAuthority('PERM_DELETE_MENU_PERMISSIONS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
