...
public class MenuController {
    ...
    @PreAuthorize("hasAuthority('PERM_VIEW_MENUS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PostMapping("store")
    @PreAuthorize("hasAuthority('PERM_CREATE_MENUS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PutMapping("/update")
    @PreAuthorize("hasAuthority('PERM_UPDATE_MENUS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @DeleteMapping("/{id}")
    @PreAuthorize("hasAuthority('PERM_DELETE_MENUS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
