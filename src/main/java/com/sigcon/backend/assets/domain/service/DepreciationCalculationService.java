...
import com.sigcon.backend.assets.application.AssetDepreciationResultDTO;
import com.sigcon.backend.assets.application.AssetSkippedDTO;
import com.sigcon.backend.assets.application.AssetSkippedDTO.SkipReason;
...
public class DepreciationCalculationService {
    ...
    public DepreciationCalculationResponseDTO calculate(String period) {
        ...
        // 12. Persistir batch (MEJORA 2 — saveAll fuera del loop)
        if (!toSave.isEmpty()) {
