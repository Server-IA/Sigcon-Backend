...
public class CashController {
    ...
    @PostMapping("/store")
    @PreAuthorize("hasAuthority('PERM_BNK.CAJAS.CREAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PreAuthorize("hasAuthority('PERM_BNK.CAJAS.EDITAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PreAuthorize("hasAuthority('PERM_BNK.CAJAS.ELIMINAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PreAuthorize("hasAuthority('PERM_CHANGE_CASH_STATUS') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PostMapping("/search")
    @PreAuthorize("hasAuthority('PERM_BNK.CAJAS.VER') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
