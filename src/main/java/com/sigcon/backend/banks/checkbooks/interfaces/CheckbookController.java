...
public class CheckbookController {
    ...
    // =========================
    @PostMapping
    @PreAuthorize("hasAuthority('PERM_BNK.CHEQUERAS.CREAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    // =========================
    @PutMapping("/{id}")
    @PreAuthorize("hasAuthority('PERM_BNK.CHEQUERAS.EDITAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    // =========================
    @PostMapping("/delete")
    @PreAuthorize("hasAuthority('PERM_BNK.CHEQUERAS.ELIMINAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    // =========================
    @PostMapping("/search")
    @PreAuthorize("hasAuthority('PERM_BNK.CHEQUERAS.VER') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    @Operation(
