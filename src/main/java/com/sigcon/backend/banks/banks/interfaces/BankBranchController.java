...
public class BankBranchController {
    ...
    @PreAuthorize("hasAuthority('PERM_BNK.SUCURSALES.CREAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PreAuthorize("hasAuthority('PERM_BNK.SUCURSALES.VER') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PreAuthorize("hasAuthority('PERM_BNK.SUCURSALES.EDITAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PreAuthorize("hasAuthority('PERM_BNK.SUCURSALES.ELIMINAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
