...
public class DataInitializer implements CommandLineRunner {
    ...
    public void run(String... args) {
        ...
        Long moduleId = createOrUpdateModule("Parametrización", "Gestión de parámetros del sistema", "parametrizacion",
                "bx-cog", 1);
        ...
        Permission deleteRole = createPermission("Eliminar roles", "Permiso para eliminar roles", TypePermits.DELETE,
                "DELETE_ROLE", moduleId);
        Permission assignRole = createPermission("Asignar roles", "Permiso para asignar roles", TypePermits.CREATE,
                "ASSIGN_ROLE", moduleId);

        Permission viewUsers = createPermission("Obtener usuarios", "Permiso para ver usuarios", TypePermits.READ,
                "VIEW_USERS", moduleId);
        Permission createUsers = createPermission("Crear usuarios", "Permiso para crear usuarios", TypePermits.CREATE,
        ...
        Permission createPermission = createPermission("Crear permisos", "Permiso para crear permisos",
                TypePermits.CREATE, "CREATE_PERMISSION", moduleId);
        Permission updatePermission = createPermission("Actualizar permisos", "Permiso para actualizar permisos",
                TypePermits.UPDATE, "UPDATE_PERMISSION", moduleId);
        Permission viewPermissions = createPermission("Obtener permisos", "Permiso para ver permisos", TypePermits.READ,
        ...
        Permission createChartOfAccount = createPermission("Crear cuentas de contabilidad",
                "Permiso para crear cuentas de contabilidad", TypePermits.CREATE, "CREATE_CHART_OF_ACCOUNT", moduleId);
        Permission viewChartOfAccount = createPermission("Ver cuentas de contabilidad",
                "Permiso para ver cuentas de contabilidad", TypePermits.READ, "VIEW_CHART_OF_ACCOUNT", moduleId);
        Permission updateChartOfAccount = createPermission("Actualizar cuentas de contabilidad",
                "Permiso para actualizar cuentas de contabilidad", TypePermits.UPDATE, "UPDATE_CHART_OF_ACCOUNT", moduleId);
        Permission deleteChartOfAccount = createPermission("Eliminar cuentas de contabilidad",
                "Permiso para eliminar cuentas de contabilidad", TypePermits.DELETE, "DELETE_CHART_OF_ACCOUNT", moduleId);

        Permission viewMenus = createPermission("Ver menús", "Permiso para ver menús", TypePermits.READ, "VIEW_MENUS",
                moduleId);
        ...
        Permission deleteMenus = createPermission("Eliminar menús", "Permiso para eliminar menús", TypePermits.DELETE,
        ...
        Permission viewParameter = createPermission("Ver parámetros", "Permiso para ver parámetros", TypePermits.READ,
                "VIEW_PARAMETER", moduleId);
        Permission updateParameter = createPermission("Actualizar parámetros", "Permiso para actualizar parámetros",
        ...
        Permission viewMenuPermissions = createPermission("Ver permisos de menús", "Permiso para ver permisos de menús",
                TypePermits.READ, "VIEW_MENU_PERMISSIONS", moduleId);
        Permission createMenuPermissions = createPermission("Crear permisos de menús",
                "Permiso para crear permisos de menús", TypePermits.CREATE, "CREATE_MENU_PERMISSIONS", moduleId);
        Permission updateMenuPermissions = createPermission("Actualizar permisos de menús",
                "Permiso para actualizar permisos de menús", TypePermits.UPDATE, "UPDATE_MENU_PERMISSIONS", moduleId);
        Permission deleteMenuPermissions = createPermission("Eliminar permisos de menús",
                "Permiso para eliminar permisos de menús", TypePermits.DELETE, "DELETE_MENU_PERMISSIONS", moduleId);

        Permission viewCostCenters = createPermission("Ver centros de costo", "Permiso para ver centros de costo",
                TypePermits.READ, "VIEW_COST_CENTERS", moduleId);
        Permission createCostCenter = createPermission("Crear centros de costo", "Permiso para crear centros de costo",
    ...
    private void createOrUpdateMenu(String label, String url, String icon, int menuOrder, Long parentId, Long moduleId,
            String component) {
