...
public class RiskRuleController {
    ...
    @PreAuthorize("hasAuthority('PERM_AU.REGLAS.VER') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    @GetMapping
    ...
    @PreAuthorize("hasAuthority('PERM_AU.REGLAS.CREAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    @PostMapping
    ...
    @PreAuthorize("hasAuthority('PERM_AU.REGLAS.EDITAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    @PutMapping("/{id}")
    ...
    @PreAuthorize("hasAuthority('PERM_AU.REGLAS.TOGGLE') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    ...
    @PreAuthorize("hasAuthority('PERM_AU.REGLAS.ELIMINAR') or hasAnyAuthority('ROLE_ADMIN_EMPRESA','PLATFORM_ADMIN')")
    @DeleteMapping("/{id}")
