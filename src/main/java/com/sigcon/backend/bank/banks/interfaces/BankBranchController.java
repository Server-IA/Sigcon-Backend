package com.sigcon.backend.bank.banks.interfaces;

import com.sigcon.backend.bank.banks.application.BankBranchDTO;
import com.sigcon.backend.bank.banks.domain.service.BankBranchService;
...
@Tag(name = "Sucursales Bancarias", description = "Endpoints para gestión de sucursales bancarias")
...
public class BankBranchController {
    ...
    @Operation(
        ...
        description = "Crea una sucursal bancaria asociada a un banco.",
    ...
    @Operation(
        ...
        description = "Consulta paginada de sucursales con filtros (DataTable).",
        requestBody = @io.swagger.v3.oas.annotations.parameters.RequestBody(
            required = false,
    ...
    @Operation(
        ...
        description = "Retorna la información detallada de una sucursal por ID."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Retorna todas las sucursales activas asociadas a un banco específico."
    )
    @ApiResponses({
    ...
    @Operation(
        ...
        description = "Eliminación lógica de la sucursal."
    )
    @ApiResponses({
