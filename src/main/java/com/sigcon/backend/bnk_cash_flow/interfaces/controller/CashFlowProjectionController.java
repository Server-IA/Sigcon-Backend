package com.sigcon.backend.bnk_cash_flow.interfaces.controller;
...
import com.sigcon.backend.bnk_cash_flow.domain.service.CashFlowProjectionService;
...
@Tag(name = "BNK — Flujo de Caja", description = "Endpoints para gestión de proyecciones de flujo de caja")
