...
public class ExchangeRateController {
    ...
    @PreAuthorize("hasAuthority('PERM_CREATE_EXCHANGE_RATES')")
    ...
    @PostMapping("/search")
    @PreAuthorize("hasAuthority('PERM_VIEW_EXCHANGE_RATES')")
    ...
    @PreAuthorize("hasAuthority('PERM_UPDATE_EXCHANGE_RATES')")
    ...
    @PreAuthorize("hasAuthority('PERM_DELETE_EXCHANGE_RATES')")
