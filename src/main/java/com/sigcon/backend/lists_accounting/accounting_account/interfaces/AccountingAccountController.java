...
public class AccountingAccountController {
     ...
     */
    @Operation(
        summary = "Consultar cuentas contables", 
        description = "Retorna un listado paginado de cuentas contables activas según los filtros especificados en el requerimiento CFG-RF-06. " +
    ...
    public ResponseEntity<?> getAccountingAccounts(
        ...
        @ModelAttribute AccountFilterRequest filters
    ) {
        try{
            ...
            return accountingAccountService.getAccountingAccounts(dtRequest, filters);
        } catch (Exception e) {
    ...
    @Operation(
        ...
        description = "Registra una nueva cuenta contable en el catálogo PUC según las especificaciones del requerimiento CFG-RF-05. " +
     ...
     */
    @Operation(
        summary = "Actualizar cuenta contable existente", 
        description = "Modifica los campos editables de una cuenta contable según las especificaciones del requerimiento CFG-RF-07. " +
     ...
     */
    @Operation(
        summary = "Inactivar cuenta contable (eliminación lógica)", 
        description = "Realiza un borrado lógico de una cuenta contable marcándola como inactiva según el requerimiento CFG-RF-08. " +
